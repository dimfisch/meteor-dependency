  ...
  if (! self.handle) {
    self.handle = Meteor.autorun(function () {
      ...
      var updateCircles = function (group) {
        ...
        .attr("r", radius)
        .attr("class", function (party) { return party.public ? "public" : "private"; })
        .style('opacity', function (party) { return selected === party._id ? 1 : 0.6; });
      };
      ...
      var updateLabels = function (group) {
        ...
        .style('font-size', function (party) { return radius(party) * 1.25 + "px"; });
      };
